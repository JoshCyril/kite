<div class="pt-10 mt-10 border-t border-gray-100 comments-box">
    <h2 class="mb-5 text-2xl font-semibold text-gray-900">
        <x-heroicon-m-chat-bubble-left-right class="inline-block w-8 h-8 mr-2 text-gray-400"/> Comments</h2>
    @auth
        ...
        <button wire:click="quoteComment"
    ...
    @else
        <a wire:navigate class="py-1 text-purple-700 underline" href="{{ route('login') }}"> Login to Quote Comments</a>
    @endauth
        ...
        @forelse($this->comments as $comment)
            ...
            <div class="comment [&:not(:last-child)]:border-b border-gray-100 py-5">
                <div class="flex items-center mb-4 text-sm user-meta">
                    <x-quotes.author :user="$comment->user" size="sm" />
